...
namespace CollectifyAPI.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(SignInManager<AppUser> signInManager, UserManager<AppUser> userManager, TokenService tokenService, AccountService accountService, IHttpContextAccessor httpContextAccessor)
        {
